...
namespace TronNet.Test
{
    public class ShastaTestTransactionSign
    {
        ...
        /// <returns></returns>
        [Fact]
        public async Task ShastaTestTransactionSignAsync()
        {
            ...
            var transactionExtension = await CreateShastaTestTransactionAsync(from, to, amount);
            ...
            var transaction4 = ShastaTestTransactionSign2Byte(transactionBytes, privateStr.HexToByteArray(), transactionSigned);
        ...
        /// <returns></returns>
        private async Task<TransactionExtention> CreateShastaTestTransactionAsync(string from, string to, long amount)
        {
        ...
        private byte[] ShastaTestTransactionSign2Byte(byte[] transaction, byte[] privateKey, Transaction transactionSigned)
        {
